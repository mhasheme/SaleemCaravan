...
import com.webbasedsolutions.scinvestments.model.Client;
import com.webbasedsolutions.scinvestments.model.ClientContent;
                        ...
                        try {
                            ...
                            h.post(new Runnable() {
                                ...
                                public void run() {
                                    ...
                                    recyclerView.setAdapter(new SimpleItemRecyclerViewAdapter((ClientListActivity) ctx, ClientContent.ITEMS, mTwoPane));
